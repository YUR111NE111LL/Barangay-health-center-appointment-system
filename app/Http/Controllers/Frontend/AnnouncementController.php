...
class AnnouncementController extends Controller
{
    public function index(): View
    {
        ...
        return view('frontend.announcements.index', compact('announcements', 'hasAnnouncementsEvents'));
    }
    ...
    public function show(Announcement $announcement): View
    {
        ...
        return view('frontend.announcements.show', compact('announcement', 'hasAnnouncementsEvents'));
    }
}
