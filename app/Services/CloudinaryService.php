    ...
    public static function uploadImage(UploadedFile $file, string $folder = 'uploads', array $options = []): ?array
    {
        try {
            ...
            if (isset($options['transformation']) && is_array($options['transformation'])) {
                ...
                if (isset($transformation['width'])) $transformationArray['width'] = $transformation['width'];
                if (isset($transformation['height'])) $transformationArray['height'] = $transformation['height'];
                if (isset($transformation['crop'])) $transformationArray['crop'] = $transformation['crop'];
                if (isset($transformation['gravity'])) $transformationArray['gravity'] = $transformation['gravity'];
                if (isset($transformation['quality'])) $transformationArray['quality'] = $transformation['quality'];
                if (isset($transformation['format'])) $transformationArray['format'] = $transformation['format'];
