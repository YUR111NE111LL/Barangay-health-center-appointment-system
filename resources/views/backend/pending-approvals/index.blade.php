...
<div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <div>
        ...
        <p class="mt-1 text-slate-500">Staff and Nurse signups for your barangay need your approval before they can log in.</p>
    </div>
</div>
                ...
                <tbody class="divide-y divide-slate-200 bg-white">
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            <form action="{{ route('backend.pending-approvals.deny', $u) }}" method="POST" class="inline ml-2">
                                @csrf
                                @method('DELETE')
