...
<div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex flex-wrap gap-2">
        <a href="{{ route('super-admin.tenant-audit-logs.index') }}" class="inline-flex items-center gap-2 rounded-xl border border-indigo-300 bg-indigo-50 px-4 py-2.5 font-medium text-indigo-700 shadow-sm hover:bg-indigo-100">
